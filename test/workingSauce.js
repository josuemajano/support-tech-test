...
describe('Working Sauce', function () {
    ...
    // Task I //update to run I am link
        //await driver.findElement(By.id("i am a link")).click()

    // Task II //clear text to say "Sauce"
        await driver.findElement(By.id("i_am_a_textbox")).clear()
        await driver.findElement(By.id("i_am_a_textbox")).sendKeys("Sauce")

    // Task III // update the code and add email and comments to click send
        await driver.findElement(By.id("fbemail")).sendKeys("josue_majano@yahoo.com")
        await driver.findElement(By.id("comments")).sendKeys("Hey there, hoping this works!")
